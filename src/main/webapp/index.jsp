...
<link
	...
	rel="stylesheet">
<script
	src="${ctx }/static/bootstrap-3.3.7-dist/js/bootstrap.min.js"></script>
</head>
<body>
<!-- 员工修改的模态框 -->
        ...
        <form class="form-horizontal">
		  ...
		  <div class="form-group">
		   <label for="email_add_input" class="col-sm-2 control-label">邮箱</label>
		    <div class="col-sm-10">
		      <input name="email" type="text" class="form-control" id="email_update_input" placeholder="email@qq.com">
		   ...
		   <label for="gender_update_input" class="col-sm-2 control-label">性别</label>
		    <div class="col-sm-10">
				<label class="radio-inline">
			  		<input name="gender" type="radio" name="inlineRadioOptions" id="genderBoy_add_input" value="男" checked="checked"> 男
				</label>
				<label class="radio-inline">
			  		<input name="gender" type="radio" name="inlineRadioOptions" id="genderGirl_add_input" value="女"> 女
				</label>
		    </div>
		  </div>
		   <div class="form-group">
		   <label for="dept_add_input" class="col-sm-2 control-label">所属部门</label>
		    <div class="col-sm-4">
  ...
  <div class="modal-dialog" role="document">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal">
		  <div class="form-group">
		    <label for="empName_add_input" class="col-sm-2 control-label">员工姓名</label>
		    <div class="col-sm-10">
		      <input name="empName" type="text" class="form-control" id="empName_add_input" placeholder="输入员工姓名">
		      <span class="help-block"></span>
		    </div>
		  </div>
		  <div class="form-group">
		   <label for="email_add_input" class="col-sm-2 control-label">邮箱</label>
		    <div class="col-sm-10">
		      <input name="email" type="text" class="form-control" id="email_add_input" placeholder="email@qq.com">
		      <span class="help-block"></span>
		    </div>
		  </div>
		  <div class="form-group">
	...
	<script type="text/javascript">
		...
		function build_page_nave(result){
			...
			navElement.appendTo("#page_nave_area");
		}
		//清空表单内容及样式
		...
		function validate_add_from(){
			//1、拿到需要校验的数据，使用正则表达式（校验员工姓名）
			var empName = $("#empName_add_input").val();
			var regName = /(^[a-zA-Z0-9_-]{6,16}$)|(^[\u2E80-\u9FFF]{2,5})/;
			if(!regName.test(empName)){
				/* alert("用户名可以是2-5中文或6-16位英文与数字组合！"); */
				//应该清空这元素之前样式
				show_validate_msg("#empName_add_input","error","用户名可以是2-5中文或6-16位英文与数字组合！");
				return false;
			}else{
		...
		$("#emp_add_btn").click(function(){
			...
			//将表单数据序列化
			var serializeData = $("#empAddModal form").serialize();
		...
		//1、在按钮创建之前就绑定了click，所以同类名是绑定不上单击事件的
		//1）可以在创建按钮的时候绑定，但是比较麻烦2）绑定点击.live()
		//jquery新版本没有live方法，使用on进行替代
